...
Le MiniPublic En Commun est une adaptation originale développée par l'association En Commun pour les communes suisses où la norme SIA est en vigueur, à l'échelle des projets d'aménagement de taille moyenne.

### Pour qui ?

- Communes, collectivités publiques et propriétaires privé·e·s porteur·euse·s de projets urbains, architecturaux ou paysagers
- Bureaux d'assistance à maîtrise d'ouvrage (AMO) souhaitant intégrer l'expertise d'usage à leurs mandats
- Concepteur·rice·s intéressé·e·s à intégrer l'expertise d'usage à leur processus de projet
- Facilitateur·rice·s et praticien·ne·s agissant comme assistant·e·s à maîtrise d'usage
- Chercheur·euse·s en démocratie délibérative et urbanisme participatif

### Ce que cette méthode n'est pas

- Une consultation publique classique (pas d'ouverture à tou·te·s)
- Un sondage d'opinion
- Un remplacement de la procédure MEP/SIA — elle s'y articule
- Un processus décisionnel : les habitant·e·s et usager·ère·s produisent des rapports d'expertise d'usage, la décision reste à la maîtrise d'ouvrage
...
Les contributions sont bienvenues : retours d'expérience, adaptations locales, corrections, traductions. Voir [`CONTRIBUTING.md`](./CONTRIBUTING.md).
...
- **MiniPublic**: a deliberative process based on sortition (random selection), grounded in academic literature on deliberative democracy (Fishkin, Gastil, Sintomer, Courant)
- **MEP** (Mandat d'étude parallèle): a parallel study mandate, an architectural competition procedure defined by Swiss standard SIA 143. In this context, the jury is referred to as the Expert Panel (Collège d'expert·e·s).

MiniPublic En Commun is an original adaptation developed by association En Commun for Swiss municipalities where SIA standards apply, at the scale of medium-sized urban and architectural projects.

### Who is it for?

- Municipalities, public authorities and private project owners of urban, architectural or landscape projects
- Project management assistance offices (AMO) seeking to integrate lived expertise into their mandates
- Designers and architects interested in integrating lived expertise into their project process
- Facilitators and participation practitioners acting as lived expertise assistants (AMU)
- Researchers in deliberative democracy and participatory urban planning

### What this method is not

- A traditional public consultation (not open to all)
- An opinion poll
- A replacement for the MEP/SIA procedure — it articulates with it
- A decision-making process: inhabitants and users produce lived expertise reports, decision-making authority remains with the project owner
...
Contributions are welcome: experience feedback, local adaptations, corrections, translations. See [`CONTRIBUTING.md`](./CONTRIBUTING.md).
...
- Courant, D. (2019). *Penser le tirage au sort*. Raisons politiques, 74.
- SIA (2020). *Norme SIA 143 : Concours d'architecture et d'ingénierie*. Société suisse des ingénieurs et des architectes.
- OCDE/OECD (2020). *Catching the Deliberative Wave*. OECD Publishing.

---

*Association En Commun — Assistance à maîtrise d'usage pour les projets urbains, architecturaux et paysagers en Suisse — [www.encommun.ch](https://www.encommun.ch)*
